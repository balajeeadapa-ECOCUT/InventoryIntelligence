...
export default function Products() {
  ...
  // Parse JSON QR codes generated by the QR label printer
  // Format: {"sku":"...","name":"...","barcode":"...","id":...}
  let searchTerm = scanned.trim();
  try {
    const parsed = JSON.parse(scanned);
    // Prefer barcode, then sku, then name for searching
    searchTerm = parsed.barcode || parsed.sku || parsed.name || scanned;
  } catch {
    // Not JSON — use raw scanned value as-is
  }
  toast({
